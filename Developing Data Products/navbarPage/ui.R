...
shinyUI(navbarPage('The Iris Dataset',
                   ...
                   tabPanel('Modelling',
                            sidebarLayout(
                                    sidebarPanel(
                                            h4('Prediction Model'),
                                            h6('Here you can choose your own measurements
                                               and get a prediction from the model.'),
                                            sliderInput('sliderPetalLength',
                                                        'Pick Petal Length Value',
                                                        0, 4,value=1),
                                            sliderInput('sliderPetalWidth',
                                                        'Pick Petal Width Value',
                                                        0, 4,value=1),
                                            sliderInput('sliderSepalLength',
                                                        'Pick Sepal Length Value',
                                                        0, 4,value=2),
                                            sliderInput('sliderSepalWidth',
                                                        'Pick Sepal Width Value',
                                                        0, 4,value=1),
                                    ...
                                    mainPanel(
                                            tabsetPanel(
                                                    ...
                                                    tabPanel('Prediction Model 2',
                                                                h3('Simple Decision Tree'), 
                                                                textOutput('text1'),
                                                                h4('Your Prediction:'),
                                                                textOutput('pred'),
                                                                plotOutput('plot3'))
